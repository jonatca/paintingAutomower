...
class Metaclass_GetMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'hqv_public_interface.srv.GetMap')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from hqv_public_interface.srv import _get_map
...
class GetMap(metaclass=Metaclass_GetMap):
    from hqv_public_interface.srv._get_map import GetMap_Request as Request
    from hqv_public_interface.srv._get_map import GetMap_Response as Response
