...
bool hqv_public_interface__msg__mower_loop_signal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hqv_public_interface.msg._mower_loop_signal.MowerLoopSignal", full_classname_dest, 59) == 0);
  }
  hqv_public_interface__msg__MowerLoopSignal * ros_message = _ros_message;
  {  // header
  ...
  {  // n
    ...
    assert(PyLong_Check(field));
    ros_message->n = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * hqv_public_interface__msg__mower_loop_signal__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MowerLoopSignal */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hqv_public_interface.msg._mower_loop_signal");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MowerLoopSignal");
  ...
  hqv_public_interface__msg__MowerLoopSignal * ros_message = (hqv_public_interface__msg__MowerLoopSignal *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
