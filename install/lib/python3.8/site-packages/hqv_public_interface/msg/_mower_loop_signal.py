...
class Metaclass_MowerLoopSignal(type):
    """Metaclass of message 'MowerLoopSignal'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'hqv_public_interface.msg.MowerLoopSignal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__mower_loop_signal
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__mower_loop_signal
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__mower_loop_signal
            cls._TYPE_SUPPORT = module.type_support_msg__msg__mower_loop_signal
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__mower_loop_signal
...
class MowerLoopSignal(metaclass=Metaclass_MowerLoopSignal):
    """Message class 'MowerLoopSignal'."""
