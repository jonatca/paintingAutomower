...
hqv_public_interface__msg__MowerAppCommand__init(hqv_public_interface__msg__MowerAppCommand * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    hqv_public_interface__msg__MowerAppCommand__fini(msg);
    return false;
  }
  // command
  return true;
...
{
  hqv_public_interface__msg__MowerAppCommand * msg = (hqv_public_interface__msg__MowerAppCommand *)malloc(sizeof(hqv_public_interface__msg__MowerAppCommand));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hqv_public_interface__msg__MowerAppCommand));
  bool success = hqv_public_interface__msg__MowerAppCommand__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
hqv_public_interface__msg__MowerAppCommand__Sequence__init(hqv_public_interface__msg__MowerAppCommand__Sequence * array, size_t size)
{
  ...
  hqv_public_interface__msg__MowerAppCommand * data = NULL;
  if (size) {
    data = (hqv_public_interface__msg__MowerAppCommand *)calloc(size, sizeof(hqv_public_interface__msg__MowerAppCommand));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hqv_public_interface__msg__MowerAppCommand__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        hqv_public_interface__msg__MowerAppCommand__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
hqv_public_interface__msg__MowerAppCommand__Sequence__fini(hqv_public_interface__msg__MowerAppCommand__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      hqv_public_interface__msg__MowerAppCommand__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  hqv_public_interface__msg__MowerAppCommand__Sequence * array = (hqv_public_interface__msg__MowerAppCommand__Sequence *)malloc(sizeof(hqv_public_interface__msg__MowerAppCommand__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = hqv_public_interface__msg__MowerAppCommand__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    hqv_public_interface__msg__MowerAppCommand__Sequence__fini(array);
  }
  free(array);
}
