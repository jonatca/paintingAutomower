...
{
  hqv_public_interface__msg__MowerRefStationPosition * msg = (hqv_public_interface__msg__MowerRefStationPosition *)malloc(sizeof(hqv_public_interface__msg__MowerRefStationPosition));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hqv_public_interface__msg__MowerRefStationPosition));
  bool success = hqv_public_interface__msg__MowerRefStationPosition__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
{
  if (msg) {
    hqv_public_interface__msg__MowerRefStationPosition__fini(msg);
  }
  free(msg);
}
...
hqv_public_interface__msg__MowerRefStationPosition__Sequence__init(hqv_public_interface__msg__MowerRefStationPosition__Sequence * array, size_t size)
{
  ...
  hqv_public_interface__msg__MowerRefStationPosition * data = NULL;
  if (size) {
    data = (hqv_public_interface__msg__MowerRefStationPosition *)calloc(size, sizeof(hqv_public_interface__msg__MowerRefStationPosition));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hqv_public_interface__msg__MowerRefStationPosition__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        hqv_public_interface__msg__MowerRefStationPosition__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
hqv_public_interface__msg__MowerRefStationPosition__Sequence__fini(hqv_public_interface__msg__MowerRefStationPosition__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      hqv_public_interface__msg__MowerRefStationPosition__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  hqv_public_interface__msg__MowerRefStationPosition__Sequence * array = (hqv_public_interface__msg__MowerRefStationPosition__Sequence *)malloc(sizeof(hqv_public_interface__msg__MowerRefStationPosition__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = hqv_public_interface__msg__MowerRefStationPosition__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    hqv_public_interface__msg__MowerRefStationPosition__Sequence__fini(array);
  }
  free(array);
}
