...
#ifndef HQV_PUBLIC_INTERFACE__SRV__DETAIL__GET_MAP__FUNCTIONS_H_
#define HQV_PUBLIC_INTERFACE__SRV__DETAIL__GET_MAP__FUNCTIONS_H_
 ...
 * calls
 * hqv_public_interface__srv__GetMap_Request__init().
...
/**
 * It calls
 * hqv_public_interface__srv__GetMap_Request__fini()
 ...
 * hqv_public_interface__srv__GetMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * hqv_public_interface__srv__GetMap_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hqv_public_interface__srv__GetMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hqv_public_interface
...
/**
 * It calls
 * hqv_public_interface__srv__GetMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hqv_public_interface
...
/**
 * It allocates the memory for the array and calls
 * hqv_public_interface__srv__GetMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hqv_public_interface
...
/**
 * It calls
 * hqv_public_interface__srv__GetMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HQV_PUBLIC_INTERFACE__SRV__DETAIL__GET_MAP__FUNCTIONS_H_
