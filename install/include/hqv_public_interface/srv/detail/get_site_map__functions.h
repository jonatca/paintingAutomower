...
#ifndef HQV_PUBLIC_INTERFACE__SRV__DETAIL__GET_SITE_MAP__FUNCTIONS_H_
#define HQV_PUBLIC_INTERFACE__SRV__DETAIL__GET_SITE_MAP__FUNCTIONS_H_
...
/// Initialize srv/GetSiteMap message.
/**
...
/// Finalize srv/GetSiteMap message.
/**
...
/// Create srv/GetSiteMap message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hqv_public_interface__srv__GetSiteMap_Request__init().
...
/// Destroy srv/GetSiteMap message.
/**
 * It calls
 * hqv_public_interface__srv__GetSiteMap_Request__fini()
...
/// Initialize array of srv/GetSiteMap messages.
/**
...
/// Finalize array of srv/GetSiteMap messages.
/**
 * It calls
 * hqv_public_interface__srv__GetSiteMap_Request__fini()
...
/// Create array of srv/GetSiteMap messages.
/**
 * It allocates the memory for the array and calls
 * hqv_public_interface__srv__GetSiteMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetSiteMap messages.
/**
 * It calls
 * hqv_public_interface__srv__GetSiteMap_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hqv_public_interface__srv__GetSiteMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hqv_public_interface
...
/**
 * It calls
 * hqv_public_interface__srv__GetSiteMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hqv_public_interface
...
/**
 * It allocates the memory for the array and calls
 * hqv_public_interface__srv__GetSiteMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hqv_public_interface
...
/**
 * It calls
 * hqv_public_interface__srv__GetSiteMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HQV_PUBLIC_INTERFACE__SRV__DETAIL__GET_SITE_MAP__FUNCTIONS_H_
