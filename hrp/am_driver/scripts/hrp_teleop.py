...
class HRP_Teleop(object):
    ...
    def init(self):
        ...
        rospy.Subscriber('sensor_status', SensorStatus,
    ...
    def showstatuslines(self):
        ...
        if self.mowerInternalState != 0:
            ...
            msg = 'ControlMode: %s            MowerState: %s' % (
                controlState, mowerState)
        else:
    ...
    def show_status(self):
        msg = 'Status:\tlinear %.2f\tangular %.2f  batA %.1f V  batB %.1f V' % (
    ...
    def process_key(self, ch):  
        ...
        if ch in self.cmd_bindings.keys():
            ...
            self.speed = self.speed * \
                (1 + self.set_bindings[ch]*self.inc_ratio)
        elif ch == 'g':
